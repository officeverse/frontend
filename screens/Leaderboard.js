    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    className="bg-white mt-2 p-2 rounded-lg"
                    onPress={() => navigation.goBack()}
                >
                    <Text style={styles.buttonText}>Home</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    className="bg-white mt-2 p-2 ml-4 rounded-lg"
                    onPress={openModal}
                >
                                ...
                                <View style={styles.popupContainer}>
                                    <View style={styles.popupContent}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            } // reset selectedPlayer to null when closing the modal
                                        >
                                            <Text>Close</Text>
                                        </TouchableOpacity>
                                    </View>

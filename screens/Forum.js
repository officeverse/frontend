        ...
        <SafeAreaView className="">
            ...
            <View>
                <View className="text-center">
                    <Text className=" text-center mt-5 mb-3">
                        Company Calendar
                    </Text>
                </View>
                <ScrollView className="max-h-[15.5vh] overflow-hidden rounded-lg mt-1">
            ...
            <View>
                <View className="text-center">
                    <Text className=" text-center mt-14 mb-3">
            ...
            <View>
                <View className="text-center">
                    <Text className=" text-center mt-14 mb-1">
                        Feedback Box
                    </Text>
